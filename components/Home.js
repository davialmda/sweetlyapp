  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.button} onPress={() => onNavigate('login')}>
        <Text style={styles.buttonText}>Login Usuário</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.button} onPress={() => onNavigate('loginEntregador')}>
        <Text style={styles.buttonText}>Login Entregador</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => onNavigate('cadastroEntregador')}>
        <Text style={styles.buttonText}>Cadastro Entregador</Text>
      </TouchableOpacity>
