...
export default function LoginPessoaJuridica({ onNavigate }) {
  ...
  const fazerLogin = async () => {
    ...
    setLoading(true);
    try {
      const response = await axios.post('http://192.168.0.7:3000/company/login', {
        email,
        password: senha
      });
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Login Pessoa Jurídica</Text>
